...
router.post("/create", protect, upload.singleFileUpload('thumbnail'), validate(courseValidation.createCourse), courseController.create);
...
router.put("/:id", protect, upload.singleFileUpload('thumbnail'), validate(courseValidation.updateCourse), courseController.update);
